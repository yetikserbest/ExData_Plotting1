#######################################################################
## This R script creates the second plot for household energy
## Energy consumption data. The second plot provides the time-series of 
## Global Active Power variable over the two days of focus
#######################################################################
...
plot(as.numeric(as.character(data$Global_active_power)),ylab="Global Active Power (kilowatts)",xlab="",type="l",xaxt="n")
